...
namespace Infoeco.infrastructure.Migrations
{
    ...
    [Migration("20231016065352_change_locatireAppartement_key")]
    partial class change_locatireAppartement_key
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.EtatDesLieuxEntite", b =>
                {
                    ...
                    b.Property<int>("LocataireAppartementAppartementId")
                        .HasColumnType("integer");

                    b.Property<int>("LocataireAppartementId")
                        .HasColumnType("integer");

                    b.Property<int>("LocataireAppartementLocataireId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LocataireAppartementLocataireId", "LocataireAppartementAppartementId");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.LocataireAppartementEntite", b =>
                {
                    ...
                    b.HasKey("LocataireId", "AppartementId");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.EtatDesLieuxEntite", b =>
                {
                    b.HasOne("Infoeco.infrastructure.Entities.LocataireAppartementEntite", "LocataireAppartement")
                        .WithMany()
                        .HasForeignKey("LocataireAppartementLocataireId", "LocataireAppartementAppartementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
